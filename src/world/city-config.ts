...
export const CITY_OBSTACLES: CityObstacle[] = [
  ...
  makeObstacle(58.0, 0, 9.0, 14.0, 0, "landmark", "Molyko Central Market Pavilion"),

  // Landmark 4: Mount Fako Ridge Panoramic Viewpoint Deck
  makeObstacle(0, -85.0, 12.0, 5.5, 0, "landmark", "Mount Fako Ridge Viewpoint Deck"),

  // Landmark 5: Buea Transit Hub & Fuel Station
  makeObstacle(-58.0, 52.0, 11.0, 8.0, 0, "landmark", "Buea Transit Fuel Station"),

  // --- CENTRAL CIVIC DISTRICT BUILDINGS ---
  makeObstacle(-14.0, -14.0, 7.5, 5.5, Math.PI / 2, "building", "Civic Commercial Bank"),
  makeObstacle(-14.0, 14.0, 7.5, 5.5, Math.PI / 2, "building", "Central Pharmacy & Clinic"),
  makeObstacle(14.0, 14.0, 7.5, 5.5, -Math.PI / 2, "building", "Central Post & Telecom Annex"),

  // --- MOLYKO MARKET SQUARE BUILDINGS & STALLS (East Block X=38..78, Z=-38..38) ---
  makeObstacle(48.0, -10.0, 4.2, 3.4, 0, "marketStall", "Market Stall Produce A"),
  makeObstacle(58.0, -10.0, 4.2, 3.4, 0, "marketStall", "Market Stall Spices B"),
  makeObstacle(68.0, -10.0, 4.2, 3.4, 0, "marketStall", "Market Stall Textiles C"),
  makeObstacle(48.0, 10.0, 4.2, 3.4, Math.PI, "marketStall", "Market Stall Crafts D"),
  makeObstacle(58.0, 10.0, 4.2, 3.4, Math.PI, "marketStall", "Market Stall Electronics E"),
  makeObstacle(68.0, 10.0, 4.2, 3.4, Math.PI, "marketStall", "Market Stall Fresh Bakery F"),
  makeObstacle(48.0, -29.0, 7.2, 5.2, 0, "building", "Market Wholesale Storehouse North"),
  makeObstacle(68.0, -29.0, 7.0, 5.2, 0, "building", "Market Artisan Guild Hall"),
  makeObstacle(48.0, 29.0, 7.2, 5.2, Math.PI, "building", "Market Wholesale Storehouse South"),
  makeObstacle(68.0, 29.0, 7.0, 5.2, Math.PI, "building", "Market Cold Storage Logistics"),

  // --- CLERKS QUARTERS RESIDENTIAL VILLAS (West Block X=-78..-38, Z=-38..38) ---
  makeObstacle(-48.0, -10.0, 7.2, 5.4, Math.PI / 2, "building", "Clerks Villa Camwood"),
  makeObstacle(-68.0, -10.0, 6.8, 5.0, -Math.PI / 2, "building", "Clerks Villa Hibiscus"),
  makeObstacle(-48.0, 10.0, 7.2, 5.4, Math.PI / 2, "building", "Clerks Villa Palm Crest"),
  makeObstacle(-68.0, 10.0, 6.8, 5.0, -Math.PI / 2, "building", "Clerks Villa Acacia"),
  makeObstacle(-48.0, -29.0, 7.0, 5.2, 0, "building", "Clerks Upper Residence West"),
  makeObstacle(-68.0, -29.0, 6.5, 5.0, 0, "building", "Clerks Compound Manor North"),
  makeObstacle(-48.0, 29.0, 7.0, 5.2, Math.PI, "building", "Clerks Lower Residence West"),
  makeObstacle(-68.0, 29.0, 6.5, 5.0, Math.PI, "building", "Clerks Compound Manor South"),

  // --- MOUNT FAKO HEIGHTS & RIDGE VILLAS (North Block Z=-78..-38) ---
  makeObstacle(-18.0, -48.0, 8.0, 5.8, 0, "building", "Highland Tea Estate Villa 1"),
  makeObstacle(18.0, -48.0, 8.0, 5.8, 0, "building", "Highland Tea Estate Villa 2"),
  makeObstacle(-18.0, -68.0, 8.5, 6.0, 0, "building", "Mount Fako Summit Manor West"),
  makeObstacle(18.0, -68.0, 8.5, 6.0, 0, "building", "Mount Fako Summit Manor East"),
  ...
  makeObstacle(-18.0, 48.0, 7.8, 5.5, Math.PI, "building", "Valley Plantation Villa 1"),
  makeObstacle(18.0, 48.0, 7.8, 5.5, Math.PI, "building", "Valley Plantation Villa 2"),
  makeObstacle(-18.0, 68.0, 9.0, 6.5, Math.PI, "building", "Greenfield South Logistics Depot 1"),
  makeObstacle(18.0, 68.0, 9.0, 6.5, Math.PI, "building", "Greenfield South Logistics Depot 2"),
  makeObstacle(58.0, 58.0, 9.0, 6.5, Math.PI, "building", "South-East Valley Agro Hub"),

  // --- OUTER PERIMETER BUFFER BUILDINGS (Set back safely from X=±78, Z=±78) ---
  makeObstacle(-85.0, -58.0, 7.0, 5.2, Math.PI / 2, "building", "West Perimeter Villa NW"),
  makeObstacle(-85.0, -19.0, 7.0, 5.2, Math.PI / 2, "building", "West Perimeter Villa Mid-N"),
  makeObstacle(-85.0, 19.0, 7.0, 5.2, Math.PI / 2, "building", "West Perimeter Villa Mid-S"),
  makeObstacle(-85.0, 58.0, 7.0, 5.2, Math.PI / 2, "building", "West Perimeter Service Garage"),
  makeObstacle(85.0, -58.0, 7.0, 5.2, -Math.PI / 2, "building", "East Perimeter Storehouse NE"),
  makeObstacle(85.0, -19.0, 7.0, 5.2, -Math.PI / 2, "building", "East Perimeter Market Annex"),
  makeObstacle(85.0, 19.0, 7.0, 5.2, -Math.PI / 2, "building", "East Perimeter Agro Store"),
  makeObstacle(85.0, 58.0, 7.0, 5.2, -Math.PI / 2, "building", "East Perimeter Warehouse SE"),
];
